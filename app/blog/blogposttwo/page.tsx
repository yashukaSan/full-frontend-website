        ...
        <div>
          ...
          <div>
            ...
            <p>
              ...
              evolve with it. Your goal should be to make it feel right for
              right now. Later will take care of itself. It always does.
            </p>
          </div>
          <div>
            <button onClick={() => router.back()}>&lt; Blog Post One</button>
            <button onClick={() => router.push("/blog/blogpostthree")}>
              Blog Post Three &gt;
            </button>
          </div>
        </div>
