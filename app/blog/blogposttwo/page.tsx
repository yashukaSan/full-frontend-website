...
function BlogPostFour() {
   ...
   * Dropcap: Libre Baskerville in Sakura Pink
   */
  const bodyText =
    "text-pink-900/80 font-['Roboto','Open_Sans'] text-lg leading-relaxed mb-6 first-letter:text-6xl first-letter:font-bold first-letter:text-pink-400 first-letter:mr-3 first-letter:float-left first-letter:font-['Libre_Baskerville']";

  return (
    <div className="bg-white selection:bg-pink-100">
      <Header blog={true} contact={false} />

      {/* --- POST HEADER: Soft Petal Backdrop --- */}
      <section className="min-h-[40vh] flex flex-col items-center justify-center text-center px-6 bg-[#fff5f7] border-b border-pink-100">
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          <p className="text-pink-400 font-['Lora'] italic">By &apos;</p>
          <div className="h-px w-12 bg-pink-200"></div>
        </div>
      </section>

      {/* --- MAIN CONTENT: Sakura Journal Style --- */}
      <main className={sectionBase}>
        <article className="max-w-3xl w-full">
          <div className="mb-12">
            ...
            {/* Pull Quote: Lora Font + Blossom Pink Accent */}
            <div className="my-12 p-10 bg-[#fdf2f4] rounded-3xl border-l-4 border-pink-400 relative">
              <Quote
          ...
          {/* --- NAVIGATION: Raleway Bold Sakura --- */}
      ...
      {/* --- MINI CTA: Blossom Transition --- */}
      <section className="py-20 bg-[#fff5f7] flex flex-col items-center text-center px-6">
        ...
        <button className="bg-pink-500 text-white px-8 py-3 rounded-full font-['Raleway'] font-bold hover:bg-pink-600 transition-all shadow-lg shadow-pink-100">
          Subscribe Now
        </button>
      </section>
